...
2. Descompacte o arquivo `DataAnalyst_case_study_data.csv.zip` para que o `.csv` fique na mesma pasta do script Python.
3. Certifique-se de ter as bibliotecas necessárias instaladas. Você pode instalá-las rodando o comando abaixo no seu terminal:
